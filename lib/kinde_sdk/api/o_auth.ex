...
defmodule KindeSDK.Api.OAuth do
  ...
  """
  @spec get_user(Tesla.Env.client, keyword()) :: {:ok, nil} | {:ok, KindeSDK.Model.UserProfile.t} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_user_profile_v2(Tesla.Env.client, keyword()) :: {:ok, nil} | {:ok, KindeSDK.Model.UserProfileV2.t} | {:error, Tesla.Env.t}
