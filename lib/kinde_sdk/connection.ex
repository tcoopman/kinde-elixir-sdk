...
defmodule KindeSDK.Connection do
  @moduledoc """
  Handle Tesla connections for KindeSDK.

  Additional middleware can be set in the compile-time or runtime configuration:

      config :tesla, KindeSDK.Connection,
        base_url: "https://app.kinde.com",
  ...
  def middleware(options \\ []) do
    base_url =
      Keyword.get(
        options,
        :base_url,
        Application.get_env(:kinde_sdk, :base_url, @default_base_url)
      )
    ...
    user_agent =
      Keyword.get(
        ...
        Keyword.get(
          tesla_options,
          :user_agent,
          "openapi-generator - KindeSDK 1.0.0 - elixir"
        )
      )
